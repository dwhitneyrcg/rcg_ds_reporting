...
E-Commerce Customer Targeting: Journey Orchestration Vendor Review
...
Digital – Guest Services Chatbot Project
...
### SEAT: Medallia Data & Feedback Insights
...
### Contact Center Intelligence & Leads
...
**CEL**** ****Revenue Management ****| ICGTLD Duplicate Row Resolution**
...
**CEL**** ****Revenue Management ****| FIT Re-berthing | AUG**
...
**CEL**** ****Revenue Management ****| GROUPS Replenishment**
...
**RCI ****Revenue Management ****| Model Upgrades | PRE Australia Price Upload**
...
•Met with business 8/19/25. Reviewed initial model plots and optimization logic. Shared output table, highlighting how track, inventory, pricing, and optimal booking shares are integrated. Business is aligned in logic and how results will be used.

•Backtesting all 2.0 and 3.0 models.

Lamis

**RCI Revenue Management | ****Create Data-Driven ****Bkg**** waves instead of the hard-coded ones. Integrate these into the optimization logic**
...
RCI Revenue Management: PRE Logic Testing - Aug Pt 2
...
**RCI Revenue Management: ****Recreating VPS ****Pricing ****Dataset**
...
**LOYALTY | Create Consumer List for Choice Benefits Pilot**
